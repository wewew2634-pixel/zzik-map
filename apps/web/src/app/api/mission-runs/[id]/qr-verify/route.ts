// ZZIK LIVE v4 - POST /api/mission-runs/[id]/qr-verify
...
import { QrVerifyBodySchema } from "@/core/missions/validation";
...
export async function POST(
  ...
  return handleApi(async () => {
    ...
    const body = QrVerifyBodySchema.parse(await req.json());

    const updated = await verifyQr({
      missionRunId,
      userId,
    ...
    return {
      ...
      qrVerifiedAt: updated.qrVerifiedAt,
    };
  }, { headers });
}
